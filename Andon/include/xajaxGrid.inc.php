 ...
 * 
 * @package XajaxGrid
 * @version $Id: xajaxGrid.inc.php,v 1.2 2014/05/07 17:34:35 cvs Exp $
...
//   			$row .= '<td id="'.$nameCell.'" style="cursor: pointer;" '.$this->colAttrib[$ind-1].'>'.$value.'</td>'."\n";
			$row .= '<td id="'.$nameCell.'" style="cursor: pointer;" '.$this->colAttrib[$ind-1].' onDblClick="xajax_show(\''.$arr[0].'\');return false">'.$value.'</td>'."\n";
   		$ind++;
		}

//     $row .= '
//           <td align="center" width="5%">
//             <a href="?" onClick="xajax_printCert(\''.$arr[0].'\');return false;"><img src="images/print.png" border="0"></a>
//           </td>';
	...
	*/
	...
	function setFooter(){
		...
		$this->footer .= $this->search = '
			...
			<tr>
				<td width="25%" align="left"><button id="submitButton" onClick="xajax_showGrid(0,'.MAXROWSXPAGE.');return false;">Show all</button></td>
				<td colspan="2" width="50%" align="center"><div id="msgZone">&nbsp;</div></td>
			</tr>
		</table>';
		
	}
        //<td width="25%" align="left"><button id="submitButton" onClick="xajax_unsetall();xajax_showGrid(0,'.MAXROWSXPAGE.');return false;">Ver Todos</button></td>        
...
class Table {
	...
	*/
        ...
        function Top($tableTitle = "tableTitle", $formDiv = "formDiv"){
                $table = '
                        <table border="1" align="center" class="adminlist">
                          ...
                          <tr>
                            <td><fieldset><legend>'.$tableTitle.'</legend>';
