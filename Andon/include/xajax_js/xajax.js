...
/* JJVEMA - Modificacion especial para enviar el error a una pagina en lugar del Alert" */
/* alert(errorString); */
myWindow = window.open('','errorPage','width=800,height=600,status=no,toolbar=no,menubar=no,location=no,scrollbars=yes,resizable=no');
myWindow.document.write(errorString);
