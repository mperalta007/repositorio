 ...
 * 
 * @package xajax
 * @version $Id: xajaxResponse.inc.php,v 1.1.1.1 2014/04/21 20:17:11 cvs Exp $
...
class xajaxResponse
{
	...
	{
	// JJVEMA: Modificaciones especiales para el sistema de ingreso de los usuarios de mi aplicacion
//		global $login;
//		
//		if($login->checkLogin1()){
//			$this->_msgError = "Su sesi&oacute;n ha expirado";
//			$this->addRedirect("/login/logout.php");
//			
//		}
		//$this->addScript("xajax_openWaitScreen();");
	// JJVEMA: Fin de la modificacion
	...
	function getXML()
	{
		...
		// JJVEMA
		//$this->addRemove("divWaitingScreen");
		// JJVEMA
		return $sXML;
	}
