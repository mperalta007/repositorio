...
class Projects extends PEAR {
    ...
    */
    function &getAllRecords($start, $limit, $order = null, $date_ini = '2009-01-01 00:00:00', $date_fin = NOW){
            ...
            if($order == null){
                    $sql = "SELECT * FROM v_show_projects OFFSET $start LIMIT $limit ".$_SESSION['ordering'];
            }else{
                    $sql = "SELECT * FROM v_show_projects ORDER BY $order ".$_SESSION['ordering']." OFFSET $start LIMIT $limit ";
            }
            $_SESSION['query'] = $sql;
    ...
    */
    ...
    function &getRecordsFiltered($start, $limit, $filter = null, $content = null, $order = null, $ordering = "", $date_ini = '2009-01-01 00:00:00', $date_fin = NOW){
            ...
            if(($filter != null) and ($content != null)){
                    $sql = "SELECT * FROM v_show_projects"
                                    ." WHERE ".$filter." like '%".$content."%' "
                                    ." ORDER BY ".$order
                                    ." ".$_SESSION['ordering']
                                    ." OFFSET $start LIMIT $limit $ordering";
                    $sql2 = "SELECT * FROM v_show_projects WHERE ".$filter." like '%".$content."%'";
            }
            $_SESSION['query'] = $sql;
    ...
    */
    ...
    function &getNumRows($filter = null, $content = null, $date_ini = '2009-01-01 00:00:00', $date_fin = NOW){
            ...
            $sql = "SELECT COUNT(*) AS numRows FROM v_show_projects";

            if(($filter != null) and ($content != null)){
                    $sql = 	"SELECT COUNT(*) AS numRows "
                            ."FROM v_show_projects "
                            ."WHERE ".$filter." like '%$content%'";
            }
    ...
    */
    ...
    function &getRecordByID($id){
            ...
            $sql ="SELECT * FROM v_product_family_rough WHERE id_product_family = $id ORDER BY id";
    ...
    function formAdd(){
        ...
        */
        ...
        function insertNewRecord($f){
                ...
                $sql= "INSERT INTO projects (project,description,id_bunit) VALUES ("
                                ."'".$f['project']."', "
                                ."'".$f['description']."', "
                                ."'".$f['id_bunit']."')";
	...
	*/
        function printSelect($Empty = null, $execFunction = null,$id=0){
            if($id==0){
            if(!$Empty){
                $html = "<h5>Select Project</h5><br><select id='project' name='project'  onChange=\"xajax_".$execFunction."(document.getElementById('project').value);\">
                    <option value='0'> -- None --</option>
                    </select>";
            }else{
                $arreglo = self::getAllRecords(0, 100000, 'project');
                    
                $html = "<h5>Select Project</h5><br>
                    ...
                    while ($row=$arreglo->fetchRow()) {
                        $html .= "<option value='".$row['id']."' name='projectop'>".$row['project']."</option>";
                    }
                ...
                $arreglo =& self::getRecordbyID($id);
                    ...
                    $html = "<br><h5>Select Project</h5><br>
                    <select id='project' name='project' onChange=\"xajax_$execFunction(document.getElementById('project').value);\">
